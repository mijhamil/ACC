      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return fetch("https://cors-anywhere.herokuapp.com/https://api.darksky.net/forecast/***REMOVED***/37.334789,-121.888138", {
                headers: {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      ...
      if (error) {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h1", null, "Loading..."));
      } else {
        return (// <h2>It is {JSON.stringify(this.state.dats, null, 2)}.</h2>
          react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "The Latitude is ", JSON.stringify(this.state.dats.latitude, null, 2), "."), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "The Longitude is ", JSON.stringify(this.state.dats.latitude, null, 2), "."), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "The Time Zone is is ", JSON.stringify(this.state.dats.timezone, null, 2), "."), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("p", null, "The Current Temperature is ", JSON.stringify(this.state.dats.currently.temperature, null, 2), "."))
        );
      }
...
//# sourceMappingURL=index.js.0ece7ff35625ab8091f2.hot-update.js.map