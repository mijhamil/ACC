...
function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function componentDidMount() {
      ...
      var dats = this.getInitialProps();
      console.log("dats is" + dats);
      this.setState({
        dats: dats
      }); // fetch("https://api.darksky.net/forecast/***REMOVED***/37.334789,-121.888138", { headers: {
      //   'Access-Control-Allow-Origin':'*'
      // }})
      // .then(res => res.json())
      // .then(
...
//# sourceMappingURL=index.js.b99d6e168e268135b2e6.hot-update.js.map