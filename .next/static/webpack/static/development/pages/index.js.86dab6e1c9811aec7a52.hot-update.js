...
function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function componentDidMount() {
      ...
      console.log("hi"); // fetch("https://api.darksky.net/forecast/***REMOVED***/37.334789,-121.888138", { headers: {
      //   'Access-Control-Allow-Origin':'*'
      // }})
      // .then(res => res.json())
      // .then(
...
//# sourceMappingURL=index.js.86dab6e1c9811aec7a52.hot-update.js.map